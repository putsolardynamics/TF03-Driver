...
private:
    ...
    //std::map<int, ros::Publisher> sensor_pub;
     ...
     std::map<int, rclcpp::Publisher<sensor_msgs::msg::Range>::SharedPtr> sensor_pub;
    std::vector<rclcpp::Publisher<sensor_msgs::msg::Range>>tabpub;
    //std::map<int, sensor_msgs::Range> sensor_data;
    rclcpp::Publisher<sensor_msgs::msg::Range>::SharedPtr pubb;
    rclcpp::Publisher<sensor_msgs::msg::Range> pub;
     std::map<int, sensor_msgs::msg::Range> sensor_data;
